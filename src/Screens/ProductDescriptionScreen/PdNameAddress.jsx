					...
					<div className="col-lg-12">
						<div className="row">
							...
							<div className="col-lg-8">
								<div className="col-lg-12">
									<div className="row">
										<div className="btn_content mt-4">
											...
											<i className="ri-calendar-2-fill">18 May 2022</i>
										</div>
									</div>
									<div className="pd-address ">
										<h4 className="mb-0 mt-4">Harrison Apartments</h4>
										<p>
											{" "}
											<img
												src="images/home-small-icon/location.png"
												alt=""
											/>{" "}
											Dhervannur, Jaipur
										</p>
									...
									<div className="pd-dec">
										...
										<div className="dec-para">
											...
											Aspernatur doloribus hic minima quibusdam perferendis odio
											rem provident iure suscipit ut et animi repellat nobis
											officiis nemo ea ratione sapiente, tempore officia!
											Reprehenderit, facilis corrupti. Fugiat distinctio
											consequatur sunt nostrum, molestiae reiciendis
											repellendus, explicabo, reprehenderit nihil dolorum atque
											praesentium sequi at?
											<br />
											<br />
											Lorem, ipsum dolor sit amet consectetur adipisicing elit.
											Excepturi ipsam amet atque inventore voluptas enim. Non
											nemo ea facilis sequi.
										</div>
									</div>
								</div>
								{/* Property Detail */}
										...
										<div className="col-lg-12">
											<div className="row">
												<Slider {...settings}>
													<div className="gallery-img">
														<img
															src="images/pro-dec/CompositeLayer (10).png"
															alt=""
														/>
													</div>
												</Slider>
														...
														<div className="faq ">
															<div className="accordion">
																<div className="accordion-item" key={i}>
																	...
																	>
																		<h5 className="mt-2 margin-left-2">
																		...
																		<div className="accordion-item-body-content">
																			<div className="form-group row">
																				<p className="col-sm-12 col-form-label">
																					...
																					Doloribus eos magnam tenetur, ullam
																					nesciunt nihil porro alias vero sint
																					iusto. Lorem ipsum dolor sit amet
																					consectetur adipisicing elit.
																					Obcaecati placeat architecto ipsa at
																					recusandae neque. Culpa dignissimos
																					quidem dolores et?
																				</p>
																			</div>
																		</div>
								...
								<div className="container question_container">
									...
									<div className="row">
										<form>
											...
											<button type="submit" className="btn question_btn">
												Submit
											</button>
										</form>
									</div>
												...
												<div className="col-lg-4">
													<div className="latest-post">
														...
														<div className="latest-post-price d-flex justify-content-between mt-3">
															...
															<img
																src="images/home-small-icon/sell.png"
																alt="rent"
															/>
														</div>
							...
							<div className="col-lg-4 right-side">
									...
									<div className="contact-card">
										...
										<div className="contact-card-para">
											<small className="grey">
												...
												elit. Possimus commodi natus soluta unde eligendi
												minima?
											</small>
										</div>
										<div className="contact-card-btn">
											<button
												className="btn btn-success red red-btn"
												style={{
								...
								<div className="col-lg-10 pt-3 pb-3">
									<div className="contact-card">
										...
										<input
											type="text"
											className="form-control right-contact"
								...
								<div className="col-lg-10 pt-3 pb-3">
									<div className="contact-card">
										<div className="dec-title col-lg-12">
											<h4 className="mb-4">Top Rated Product</h4>
										</div>
										<div className="trp d-flex">
											<div className="trp-img">
												<img
													src="images/property/1 (1).png"
													alt=""
													className="img-fluid trp-img-img"
												/>
											</div>
											<div className="trp-content">
												...
												<hr style={{ borderBottom: "2px solid grey" }} />
											</div>
										</div>
										<div className="trp d-flex">
											<div className="trp-img">
								...
								<div className="col-lg-10 pt-3 pb-3">
									<div className="contact-card">
										...
										<div className="top-category col-lg-12 d-flex">
											<p className="top-category-name col-lg-8 mb-0 mt-3">
												Lorem, ipsum.
											</p>
											<p className="top-category-number col-lg-4 mb-0 mt-3">
												(10)
											</p>
										</div>
										<div className="top-category col-lg-12 d-flex">
