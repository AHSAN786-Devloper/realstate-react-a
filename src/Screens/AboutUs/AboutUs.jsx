                            ...
                            <div className="col-lg-6">
                                <div className="row mt-3">
                                    ...
                                    <div className="about-para">
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla eos voluptate sunt reprehenderit eius, iusto laborum, quas laudantium doloremque fugiat iure quis, totam magni provident. Aliquam nemo accusantium fuga sit!</p>
                                    </div>
                            ...
                            <div className="col-lg-12">
                                <div className="row mx-auto d-flex justify-content-evenly">
                                    <div className="col-lg-3 padding-2 d-flex flex-column align-items-center justify-content-center shadow-sm p-3 bg-white rounded m-3">
                                        <img src="/images/about/11 (1).png" alt="" height="80" width="80" />
                                        <h3 className="m-0">Our Mission</h3>
                                        <p className='text-center'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis totam nesciunt illo amet consequatur itaque, deserunt ipsum recusandae veniam facere laborum maiores.</p>
                                        <span><i class="fa fa-arrow-right" aria-hidden="true"></i></span>
                                    </div>
                                    <div className="col-lg-3 padding-2 d-flex flex-column align-items-center justify-content-center shadow-sm p-3 bg-white rounded m-3">
                                        <img src="/images/about/11 (2).png" alt="" height="80" width="80" />
                                        <h3 className="m-0">Our Visson</h3>
                                        <p className='text-center'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis totam nesciunt illo amet consequatur itaque, deserunt ipsum recusandae veniam facere laborum maiores.</p>
                                        <span><i class="fa fa-arrow-right" aria-hidden="true"></i></span>
                                    </div>
                                    <div className="col-lg-3 padding-2 d-flex flex-column align-items-center justify-content-center shadow-sm p-3 bg-white rounded m-3">
                                        <img src="/images/about/11 (3).png" alt="" height="80" width="80" />
                    ...
                    <div className="col-lg-12 mt-5">
                        <div className="row">
                            ...
                            <div className="col-lg-6">
                                <div className="row mt-3">
                                    <div className="about-title">
                                        <h3>What Results Are What Matter Most, We Belive awardsBring Value</h3>
                                    </div>
                                    <div className="about-para">
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla eos voluptate sunt reprehenderit eius, iusto laborum, quas laudantium doloremque fugiat iure quis, totam magni provident. Aliquam nemo accusantium fuga sit!</p>
                                    </div>
